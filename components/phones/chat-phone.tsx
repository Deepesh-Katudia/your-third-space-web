...
export function ChatPhone({ className = "" }: { className?: string }) {
  return (
    <div
      className={`h-[520px] w-[250px] shrink-0 rounded-[38px] bg-[#111] p-[9px] shadow-[0_30px_60px_-22px_rgba(43,32,21,0.45)] ${className}`}
      aria-hidden="true"
    >
      <div className="flex h-full w-full flex-col overflow-hidden rounded-[30px] bg-apricot">
